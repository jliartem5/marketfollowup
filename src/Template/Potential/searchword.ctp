...
<?= $this->Html->script('potential.js?v='.rand(1,1000)); ?>
<?php
...
?>
            <button  class='btn btn-primary product_delete' button-state='off' id='delete_ALL' data-product-searchword='<?php echo $_GET['searchword'] ?>'>
				<span style="font-size: 12px;" class="glyphicon glyphicon-trash" ></span>
				 删除全部
			</button>